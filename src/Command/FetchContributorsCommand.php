...
class FetchContributorsCommand extends Command
{
  ...
  protected $orgRepositories = [];

  protected $configExclusions = [];
  protected $configKeepExcludedUsers = false;
  protected $configExtractEmailDomain = false;
  protected $configFieldsWhitelist = [];
  protected $configExcludeRepositories = [];
